<?php session_start();
	...
	if (isset($_POST['submit'])) {
		$collection->updateOne(['_id' => new MongoDB\BSON\ObjectID($_GET['id'])], ['$set' => ['kelas' => $_POST['kelas'], 'kodekelas' => $_POST['kodekelas'], 
                      'hari' => $_POST['hari'],'matkul' => $_POST['matkul'],'sks' => $_POST['sks'],
                      'kuota' => $_POST['kuota'], ]]);
